...
def merge_data(data_deseq, data_limma, data_edger, biotype):
    ...
    merged_dataset_ens.to_csv(f"../data/Venn_Diagrams/Ensemble_data/ENSEMBLE_{biotype}_VENN_DATA.csv", index=False)
    with pd.ExcelWriter(f"../data/Venn_Diagrams/Ensemble_data/ENSEMBLE_{biotype}_VENN_DATA.xlsx") as writer:
        merged_dataset_ens.to_excel(writer, index=False)

    merged_dataset_genes.to_csv(f"../data/Venn_Diagrams/Gene_name_data/GENES_{biotype}_VENN_DATA.csv", index=False)
    with pd.ExcelWriter(f"../data/Venn_Diagrams/Gene_name_data/GENES_{biotype}_VENN_DATA.xlsx") as writer:
...
deseq = pd.read_csv(f"../data/DESeq2/All_GENES_DESeq2_RNA_SEQ.csv", index_col=1)
limma = pd.read_csv(f"../data/LimmaVoom/All_GENES_LimmaVoom_RNA_SEQ.csv", index_col=1)
edger = pd.read_csv(f"../data/EdgeR/All_GENES_EdgeR_RNA_SEQ.csv", index_col=1)
