...
plot_names <- list(
  "best_of_three_rf_DESeq2_DGE_analysis_volcano",
  "best_of_three_rf_EdgeR_DGE_analysis_volcano",
  "best_of_three_rf_LimmaVoom_DGE_analysis_volcano"
)

subset_genes <- "Best_of_Three" # "Best"  # "All" NULL "Best_of_Three"
